...
//
//public class OldMainActivity extends AppCompatActivity implements SelectFileListener {
//
...
//
//        MediaSessionCompat mediaSession = new MediaSessionCompat(this, "media_session");
...
//                    final FileObject file = new FileObject(getFileName, getArtistName, generateTime(getDuration), getFileUri);
//
...
//                fileAdapter = new FileAdapter(filesList, OldMainActivity.this);
